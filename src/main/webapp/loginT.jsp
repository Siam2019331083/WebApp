        ...
        <div class="flex justify-between items-center w-full text-white bg-purple-600 dark-mode:text-gray-200 dark-mode:bg-gray-800 shadow-lg">
            ...
            <div>
                <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                    ...
                    <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline me-4" href="/WebTechTask3/loginA.jsp">Admin</a>
            ...
            <div class="flex flex-1 items-center justify-center">
                <div class="rounded-xl sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center shadow-xl">
                    ...
                    <div class="text-center mt-12">
                        ...
                        <a href="/WebTechTask3/signup.jsp" class="font-light text-md text-purple-600 underline font-semibold hover:text-purple-800 no-underline">Create One</a>
                    </div>
                </div>
            </div>
        </div>
